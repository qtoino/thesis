...
class GenerativeF():
    ...
    def interpolation(self, audio_a, audio_b, influence_a, influence_b):
        ...
        if audio_a[0].startswith('GS_'):
            mel_a = pppipeline("https://thesis-production-0069.up.railway.app/audio/generated/"+audio_a[0])
        else:
            print(audio_a[1])
        ...
        if audio_b[0].startswith('GS_'):
            mel_b = pppipeline("https://thesis-production-0069.up.railway.app/audio/generated/"+audio_b[0])
        else:    
