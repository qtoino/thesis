...
function Info() {
    ...
    return (
        <div>
            <button className="form_element button" onClick={handleInfoClick}>Info</button>
            {showInfo && (
                <div className="info-window">
                <div className="info-content">
                    <h2>Information</h2>
                    <p>Here is some information that you wanted to display.</p>
                    <p>You can add any content you want here.</p>
                    <button className="form_element button_close" onClick={handleCloseClick}>Close</button>
                </div>
                </div>
            )}
        </div>
